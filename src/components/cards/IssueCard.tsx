...
export function IssueCard({
  ...
  return (
    <FadeIn delay={delay} className="relative aspect-[3/2] overflow-hidden border border-gold/30 @container">
      ...
      <p className="absolute bottom-6 left-5 right-5 whitespace-pre-line font-medium text-cream text-[clamp(0.875rem,7cqw,1.5rem)] [text-shadow:0_2px_6px_rgba(0,0,0,0.65)]">
        {title}
      </p>
    </FadeIn>
  );
